create table euro2024_poi_all_smallestpolygon as (
	...
	with smallest_polygon as (
		...
		join planet_osm_polygon as osm on osm.osm_id = poi.osm_id_polygon -- tuberlin_euro2024_osm
	)
	select distinct on (tile_id, osm_id_point) sp.*, poi.way_polygon
